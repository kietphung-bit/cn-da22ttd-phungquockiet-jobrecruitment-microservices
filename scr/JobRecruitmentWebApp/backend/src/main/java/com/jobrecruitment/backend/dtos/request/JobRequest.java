 ...
 * - JobStatus: PENDING (mới tạo) -> ACTIVE (sau khi Admin duyệt)
 * 
 * Tham khảo: Section 4.2 - Job Management, Section 4.6 - Data Constraints
 */
@Data
@NoArgsConstructor
@AllArgsConstructor
public class JobRequest {
     ...
     * - Optional: Có thể null (mặc định PENDING)
     * - ENUM: PENDING, WAIT, ACTIVE, CLOSED, HIDDEN
     * - Admin có quyền thay đổi trạng thái
     */
